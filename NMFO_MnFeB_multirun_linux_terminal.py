...
max_temperatures_to_run = np.linspace(TN_NMO+50, TN_NFO+100,11)
...
file_prefix_list = ["NMFO_MnFe=B_"]
for sx_fn_idx, superexchange_function in enumerate([Nd_paper.return_superexchange_list_MnFeB]):
